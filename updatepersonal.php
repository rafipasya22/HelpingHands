...
if(isset($_POST['submit'])) {
    ...
    if(!empty($Nama_Depan) || !empty($Nama_Belakang)){
        if(empty($Nama_Depan)){
            $update = "UPDATE relawan SET Nama_Belakang = '$Nama_Belakang' WHERE Email = '$Email'";
            $_SESSION['NamaBelakang'] = $Nama_Belakang;
        } else if(empty($Nama_Belakang)){
            $update = "UPDATE relawan SET Nama_Depan = '$Nama_Depan' WHERE Email = '$Email'";
            $_SESSION['NamaDepan'] = $Nama_Depan;
        } else {
            $update = "UPDATE relawan SET Nama_Depan = '$Nama_Depan', Nama_Belakang = '$Nama_Belakang' WHERE Email = '$Email'";
            $_SESSION['NamaDepan'] = $Nama_Depan;
            $_SESSION['NamaBelakang'] = $Nama_Belakang;
        }
    ...
    if(!empty($Email_Baru) && $Email_Baru != $Email) {
        $update_email = "UPDATE relawan SET Email = '$Email_Baru' WHERE Email = '$Email'";
